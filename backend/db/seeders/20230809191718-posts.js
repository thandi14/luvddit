...
module.exports = {
  async up (queryInterface, Sequelize) {
    await Posts.bulkCreate([
      ...
      { communityId: 5, userId: 2, votes: 0, downVotes: 0, title: "Rocked a vintage leather jacket today feeling like a stylish time traveler. #FashionFinds #VintageVibes" },
      ...
      { communityId: 5, userId: 3, votes: 0, downVotes: 0, title: "Casual chic with denim and a graphic tee. Comfort meets style in the heart of the city. #UrbanFashion #StreetStyle" },
      ...
      { communityId: 5, userId: 2, votes: 0, downVotes: 0, title: "Elevating everyday elegance with statement accessories and a touch of glamour. Confidence is the best accessory. #FashionStatement #ConfidentStyle" },
      ...
      { communityId: 6, userId: 2, votes: 0, downVotes: 0, title: "Lost in the charm of cobblestone streets and historic architecture. Exploring hidden gems in the heart of the old town. #Wanderlust #TravelDiaries" },
      ...
      { communityId: 7, userId: 2, votes: 0, downVotes: 0, title: "Movie night at home with 'The Shawshank Redemption.' A timeless tale of hope and friendship that never fails to inspire. #MovieMarathon #ClassicCinema" },
      ...
      { communityId: 7, userId: 2, votes: 0, downVotes: 0, title: "Laughing out loud with 'Anchorman: The Legend of Ron Burgundy.' A hilarious escape from reality that never gets old. #ComedyNight #WillFerrell" },
      ...
      { communityId: 7, userId: 3, votes: 0, downVotes: 0, title: "Unleashing my inner superhero with 'The Dark Knight.' Heath Ledger's iconic Joker and Christopher Nolan's vision redefine the superhero genre. #SuperheroDrama #CapedCrusader" },
      { communityId: 7, userId: 2, votes: 0, downVotes: 0, title: "Embarking on a cinematic journey with 'Forrest Gump.' Life's unpredictability and Tom Hanks' unforgettable performance leave a lasting impact. #LifeLessons #Heartwarming" },
      { communityId: 8, userId: 2, votes: 0, downVotes: 0, title: "Meet my furry friend, Luna!" },
      { communityId: 8, userId: 1, votes: 0, downVotes: 0, title: "Introducing Max, the world's most photogenic dog. His wagging tail and puppy eyes are the ultimate mood lifters. #DoggoLove #PawsomePal" },
      { communityId: 8, userId: 3, votes: 0, downVotes: 0, title: "Cuteness overload: my bunny, Snowball, hopping around like a fluffy little cloud. #BunnyLife #FluffyFriend" },
      { communityId: 8, userId: 2, votes: 0, downVotes: 0, title: "In the presence of greatness: my majestic parrot, Rio. His vibrant feathers and cheerful squawks brighten up even the gloomiest days. #ColorfulCompanion #FeatheredFriend" },
      { communityId: 8, userId: 1, votes: 0, downVotes: 0, title: "Say hello to Oliver, my mischievous ferret. His boundless energy and curious nature remind me to always explore and play. #FerretFun #CuriousCritter" },
      { communityId: 8, userId: 3, votes: 0, downVotes: 0, title: "Meet Peanut, my cuddly guinea pig. His gentle squeaks and popcorn-like leaps fill my heart with warmth and laughter. #GuineaPigLove #PeanutPower" },
      { communityId: 8, userId: 2, votes: 0, downVotes: 0, title: "Tiny but mighty: my hamster, Nibbles. His miniature adventures and tiny paws remind me to appreciate the little joys in life. #HamsterLife #TinyExplorer" },
      { communityId: 8, userId: 1, votes: 0, downVotes: 0, title: "Happiness is a wagging tail and a wet nose. Meet Bailey, my loyal and lovable Labrador. Every walk is an adventure and every cuddle a treasure. #LabradorLove #BestFurFriend" },
      { communityId: 8, userId: 3, votes: 0, downVotes: 0, title: "Sunny days are made for hanging out with Daisy, my charismatic bearded dragon. Her inquisitive eyes and gentle nature make her a fascinating companion. #BeardedDragon #ReptileLove" },
      { communityId: 8, userId: 2, votes: 0, downVotes: 0, title: "Double trouble: my dynamic duo of kittens, Whiskers and Paws. Their synchronized pouncing and adorable meows are a constant source of entertainment. #KittenCuteness #DynamicDuo" },
      ...
      { communityId: 6, userId: 2, votes: 0, downVotes: 0, title: "Wandering the cobbled streets of a European village, lost in the charm of old-world architecture and hidden cafes. #EuropeanEscape #VillageWanderer" },
      { communityId: 7, userId: 1, votes: 0, downVotes: 0, title: "Immersing in the magic of 'Harry Potter' once again. A journey through wizarding wonders and the power of friendship. #WizardingWorld #MagicalEscape" },
      { communityId: 8, userId: 3, votes: 0, downVotes: 0, title: "Playtime with my energetic pup, Charlie. His boundless enthusiasm and wagging tail are my daily dose of joy. #DoggoPlaytime #HappyPup" },
      { communityId: 7, userId: 2, votes: 0, downVotes: 0, title: "Cozy movie night with 'Amélie.' A whimsical tale of Parisian charm and the magic of small gestures. #FrenchCinema #WhimsicalJourney" },
