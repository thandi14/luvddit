...
module.exports = {
  async up (queryInterface, Sequelize) {
    await Post.bulkCreate([
      ...
      { communityId: 4, userId: 3, votes: 0, downVotes: 0, title: "Sushi date with friends. Rolled laughter, dipped in soy sauce, and wrapped in shared stories.", tags: "oc"},
      ...
      { communityId: 4, userId: 1, votes: 0, downVotes: 0, title: "Ice cream truck magic on a hot day. Childhood memories in a single scoop.", tags: "oc"},
      ...
      { communityId: 7, userId: 1, votes: 0, downVotes: 0, title: "Lost in the world of 'Inception' again. Mind-bending visuals and a labyrinth of dreams, a masterpiece that keeps me questioning reality. #MindBlown #MovieMagic", tags: "spoiler,nsfw" },
      ...
      { communityId: 7, userId: 3, votes: 0, downVotes: 0, title: "Diving into the unknown with 'Interstellar.' A thought-provoking journey through space and time that leaves me pondering our place in the universe. #SpaceOdyssey #Philosophy", tags: "spoiler,nsfw"  },
      ...
      { communityId: 7, userId: 1, votes: 0, downVotes: 0, title: "Movie night with a classic: 'Casablanca.' A tale of romance and sacrifice that never loses its allure. #ClassicFilm #RomanticDrama", tags: "nsfw"},
      ...
      { communityId: 7, userId: 2, votes: 0, downVotes: 0, title: "Revisiting 'The Godfather' trilogy, a cinematic masterpiece of family, power, and intrigue. An offer I can't refuse. #MovieMarathon #EpicSaga", tags: "nsfw" },
