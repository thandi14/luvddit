...
module.exports = {
  async up (queryInterface, Sequelize) {
     ...
     await await Comments.bulkCreate([
      ...
      {userId: 3, comment: "This is a unique take on the subject, nicely done!", postId: 3},
      ...
      {userId: 1, comment: "I'm inclined to agree with your well-reasoned argument.", postId: 13},
      {userId: 2, comment: "You've eloquently expressed a complex idea. Kudos!", postId: 14},
      ...
      {userId: 1, comment: "It's refreshing to see such a thoughtful contribution.", postId: 19},
      ...
      {userId: 1, comment: "I'm thoroughly enjoying the intellectual exchange happening here.", postId: 22},
      {userId: 2, comment: "Your comment is a standout amidst the noise.", postId: 23},
      {userId: 3, comment: "Your words have a certain eloquence that's hard to ignore.", postId: 24},
      {userId: 1, comment: "This is the kind of content that keeps me coming back.", postId: 25},
      ...
      {userId: 2, comment: "Complexity bows down to your knack for simplicity.", postId: 32},
      ...
      {userId: 2, comment: "You've painted a new panorama in the realm of ideas.", postId: 35},
      ...
      {userId: 1, comment: "Your comment ignited a wildfire of introspection within me.", postId: 40},
      ...
      {userId: 1, comment: "You've sculpted a masterpiece of accessibility from a complex topic.", postId: 43},
      {userId: 2, comment: "Your thoughts are cosmic threads weaving the fabric of discussion.", postId: 44},
      {userId: 3, comment: "Your comment waltzes with elegance amidst the chaos of words.", postId: 45},
      {userId: 1, comment: "In a sea of comments, yours is a lighthouse guiding minds.", postId: 46},
      {userId: 2, comment: "Your words are like a deep dive into the ocean of understanding.", postId: 47},
      {userId: 3, comment: "You've given this topic wings to soar to new heights.", postId: 48},
      {userId: 1, comment: "Your words are pillars, upholding the cathedral of diverse perspectives.", postId: 49},
      {userId: 2, comment: "Your insights are like constellations forming a map of insight.", postId: 50},
      {userId: 1, comment: "Your words are a symphony of enlightenment!", postId: 23},
      ...
      {userId: 1, comment: "Your analysis has left a vivid mark on my mind.", postId: 14},
      {userId: 2, comment: "Your comprehensive overview is like a treasure map to knowledge.", postId: 42},
      {userId: 3, comment: "Your share has transformed my thinking, thank you!", postId: 18},
      {userId: 1, comment: "Your expertise shines like a guiding star in this discussion.", postId: 37},
      ...
      {userId: 1, comment: "Your attention to detail is a masterpiece in itself.", postId: 9},
      {userId: 2, comment: "Your explanation is like a compass pointing to clarity.", postId: 49},
      {userId: 3, comment: "Your passion is a spark that ignites the entire conversation.", postId: 46},
      {userId: 1, comment: "Your well-reasoned argument is a beacon of persuasion.", postId: 25},
      ...
      {userId: 1, comment: "The depth of this conversation is a treasure to behold, thanks to you.", postId: 31},
      ...
      {userId: 1, comment: "In a sea of thoughts, your contribution stands tall like a lighthouse.", postId: 28},
      ...
      {userId: 1, comment: "Intellectual exchange is at its prime, thanks to your input.", postId: 26},
      {userId: 2, comment: "Your comment resonates like a harmonious chord in the symphony of ideas.", postId: 48},
      {userId: 3, comment: "Your eloquence is like a gentle breeze, impossible to ignore.", postId: 36},
      {userId: 1, comment: "Your content is the North Star that keeps me returning.", postId: 11},
      {userId: 2, comment: "Quality radiates from your comment like a brilliant star.", postId: 3},
      {userId: 3, comment: "Nuances bloom like flowers in your words, a garden of insight.", postId: 33},
      {userId: 1, comment: "Your well-done research has cast a spotlight on the topic.", postId: 19},
      ...
      {userId: 3, comment: "Your words resonate in perfect harmony with my thoughts.", postId: 27},
      {userId: 1, comment: "Diverse opinions come together as a symphony, conducted by your input.", postId: 22},
      {userId: 2, comment: "Your comment has given me a new lens to see through.", postId: 39},
      {userId: 3, comment: "You're pouring a fountain of value into this discussion.", postId: 4},
      {userId: 1, comment: "Your contribution is the heartbeat that makes online forums alive.", postId: 15},
      ...
      {userId: 1, comment: "Your comment is a spark that ignites reflective flames within me.", postId: 35},
      {userId: 2, comment: "Your words illuminate the power of dialogue in its purest form.", postId: 50},
      {userId: 3, comment: "Thoughtfulness is a river that flows through every word you share.", postId: 6},
      {userId: 1, comment: "You've transformed complexity into a welcoming path for all.", postId: 24},
      {userId: 2, comment: "Your words are building blocks in the grand discourse architecture.", postId: 30},
      {userId: 3, comment: "Elegance dances with insight in every corner of your comment.", postId: 20},
      {userId: 1, comment: "Your civil and insightful presence uplifts this online realm.", postId: 43},
