...
function DownvotedPosts() {
    ...
    filterdPosts = filterdPosts.filter((p) => p.Votes.some((v) => v.downVote === 1))
  ...
  useEffect(() => {
   ...
   // if (!ePost.length) return <h1 className="data-not-here"></h1>
    ...
    <div id="aHeader3">
        ...
        <span onClick={(() => history.push("/profile/posts/:page"))} id="aH8">POSTS</span>
        ...
        <span onClick={(() => history.push("/profile/downvoted/:page"))}id="aHl">DOWNVOTED</span>
