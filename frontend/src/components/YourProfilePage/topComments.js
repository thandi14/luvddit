...
function CommentedTopPosts() {
    ...
    const handleScroll = () => {
      ...
      if (windowHeight + scrollTop >= documentHeight - threshold) {
        ...
        dispatch(postsActions.thunkGetTopComments(user?.id, currentPage)); // Fetch posts for the specified page
      }
    }
  ...
  useEffect(() => {
   ...
   // if (!ePost.length) return <h1 className="data-not-here"></h1>
    ...
    <div className="filter">
        ...
        <div onClick={(() => history.push("/profile/comments/hot/:page"))}id="best">
        <i class="fi fi-rs-flame"></i>
        <p>Hot</p>
        </div>
        <div style={{ backgroundColor: "#EDEFF1"}} onClick={(() => history.push("/profile/comments/top/:page"))} id="best">
...
export default CommentedTopPosts
