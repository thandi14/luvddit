...
function PostLikes({ post, vote, downVote }) {
    ...
    return (
        <>
         <div id="upvote" onClick={((e) => e.stopPropagation())} >
        { (data && boolean) && (!boolean2) || (voted.length && !data) ? <i id="upvoted"
        ...
        {post.votes + post.downVotes === 0 && !add ? <span>Vote</span> : null }
        <div id="downvote" onClick={((e) => e.stopPropagation())} >
